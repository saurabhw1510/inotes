...
if (isset( $_POST['snoEdit'])){
  ...
  $sql = "UPDATE `notes` SET `Title` = '$title' , `Notes` = '$description' WHERE `notes`.`No.` = $sno";
  $result = mysqli_query($conn, $sql);
  if($result){
    $update = true;
}
  ...
  // Sql query to be executed
  $sql = "INSERT INTO `notes` (`Title`, `Notes`) VALUES ('$title', '$description')";
  $result = mysqli_query($conn, $sql);
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/crud">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/crud">Contact Us</a>
        </li>
